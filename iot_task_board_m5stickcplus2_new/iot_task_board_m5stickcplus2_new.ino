...
// Smart Electronic Task Board Controller for M5 StickC Plus 2
...
int keyswitchRState = -1, keyswitchLState = -1, angleValue = -1;
int portRState = -1, portLState = -1;
...
void setup() {
  ...
  // // GPIO setting
  pinMode(LED_PIN, OUTPUT);  //GPIO19 for M5StickCPlus2 the builtin LED <<THIS WAS THE PROBLEM!
