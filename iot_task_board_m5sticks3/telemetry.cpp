...
void publish_telemetry() {
  ...
  root["battVoltage(V)"] = M5.Power.getBatteryVoltage() / 1000;
  root["battCurrent(mA)"] = M5.Power.getBatteryCurrent();
  root["M5BattLevel"] = M5.Power.getBatteryLevel();
  root["M5IsCharging"] = M5.Power.isCharging();
